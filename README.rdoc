...
-If you are not using I18n (internationalization) create a all.yml file in your titles folder.

-Otherwise, create a yml file for each locale (en.yml, fr.yml, …) in your titles folder.

-Put all your titles in the yml file(s) while respecting the above format.
